...
class PlannerService:
    ...
    def generate_roadmap(self, materials_summary: str, target_date: str | None = None) -> dict:
        """
...
2. EXHAUSTIVE: Include EVERY single PDF and EVERY single video. Never skip or merge.
...
5. For video resources:
   ...
   - topics: list 3-5 concepts covered in the video.
